...
async function main() {
    const tx = await moderatorContract.getPrivileges(ersterContract, joby, "testemail", "Cryptoschool");
    console.log("The message: ", tx);
    console.log("We are waiting..");
    await tx.wait();
    const privilegeInfo = await moderatorContract.privilegesInfo();
    console.log("last Logout Info: ", privilegeInfo);
}
