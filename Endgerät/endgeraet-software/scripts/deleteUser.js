...
async function main() {
    const tx = await moderatorContract.deleteUser(ersterContract, joby, "testemail");
    console.log("The message: ", tx);
    console.log("We are waiting..");
    await tx.wait();
    const lastDeleteInfo = await moderatorContract.DeleteInfo();
    console.log("last Logout Info: ", lastDeleteInfo);
}
